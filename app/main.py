...
async def apod(request: Request): 
    return templates.TemplateResponse("apod.html", {"request": request, "serverTime": serverTime})
    
@app.get("/advice", response_class=HTMLResponse)
async def advice(request: Request): 
    return templates.TemplateResponse("advice.html", {"request": request, "data.slip.advice": data.slip.advice})
